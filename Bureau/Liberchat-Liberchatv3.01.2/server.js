...
io.on('connection', (socket) => {
  ...
  socket.on('chat message', (message) => {
    ...
    if (message.type === 'text') {
      ...
      const allowedTypes = ['image/png', 'image/jpeg', 'image/gif', 'audio/webm', 'audio/ogg', 'audio/mpeg', 'audio/mp3'];
      ...
      // Ajout : support des messages vocaux (audio/*)
      // Rien à changer ici, le type audio/webm est déjà accepté
    }
