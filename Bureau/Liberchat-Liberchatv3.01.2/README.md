...
- Enregistrez et envoyez des messages vocaux directement dans le chat grâce au bouton micro 🎤 (carré, moderne, à côté du bouton fichier).
- Lecture des messages vocaux intégrée (lecteur audio HTML5), sans lien de téléchargement.
- Enregistrement sécurisé (permissions micro requises, HTTPS ou localhost recommandé).
- Design moderne et épuré pour le bouton micro (animation lors de l’enregistrement, carré, sans texte).
